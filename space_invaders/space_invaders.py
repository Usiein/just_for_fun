...
class HUD(cocos.layer.Layer):
    ...
    def update_lives(self, lives):
        self.lives_text.element.text = f'Lives: {lives}'
...
class Alien(Actor):
    ...
    TYPES = {
        '1': (load_animation('img/alien_0.png'), 40),
        '2': (load_animation('img/alien_1.png'), 20),
        '3': (load_animation('img/alien_2.png'), 10),
    }
...
class MysteryShip(Alien):
    ...
    def __init__(self, x, y):
        ...
        super(MysteryShip, self).__init__('img/alien_3.png', x, y, score)
...
if __name__ == '__main__':
    cocos.director.director.init(caption='Space Invaders', width=800, height=650)
